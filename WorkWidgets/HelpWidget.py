...
class BounsHelpWidget(QtWidgets.QWidget):
    def __init__(self):
        ...
        bullet_lavelup_image.setStyleSheet('QPushButton{border-image:url(./TankWarGame/Image/bonus/tank.png);}')
        ...
        tank_addhp_image = QtWidgets.QPushButton()
        tank_addhp_image.setText('')
        tank_addhp_image.setStyleSheet('QPushButton{border-image:url(./TankWarGame/Image/bonus/star.png);}')
        tank_addhp_image.setFixedSize(QtCore.QSize(48,48))
        tank_addhp_image.setEnabled(False)
        tank_addhp_label = LabelComponent(16, ": Add HP for tank.")
        tank_addhp_label.setAlignment(QtCore.Qt.AlignVertical_Mask)

        layout.addWidget(header_label, 0, 0, 1, 2)
        layout.addWidget(bullet_lavelup_image, 1, 1, 1, 1)
        layout.addWidget(bullet_lavelup_label, 1, 2, 1, 1)
        layout.addWidget(tank_addhp_image, 2, 1, 1, 1)
        layout.addWidget(tank_addhp_label, 2, 2, 1, 1)
