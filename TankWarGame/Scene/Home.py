...
class Home(QtWidgets.QPushButton):
    def __init__(self, game_ui, x, y):
        ...
        self.HP = game_ui.game_info.home_hp
        self.setText('')
        self.setStyleSheet('QPushButton{border-image:url(./TankWarGame/Image/scene/home1.png);}')
        self.setGeometry(x*game_ui.game_info.bsize, y*game_ui.game_info.bsize, game_ui.game_info.bsize*2, game_ui.game_info.bsize*2)            
